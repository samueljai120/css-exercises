...
- Does the `div` element have CSS added via the external method? inline method
- Does the `p` element have CSS added via the internal method? external method
- Does the `button` element have CSS added via the inline method? internal method
